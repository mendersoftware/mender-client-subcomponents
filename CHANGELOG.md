...
- Add missing parameter definition for mender-auth's passphrase-file
 ([beb2cfd](https://github.com/mendersoftware/mender/commit/beb2cfde32c5efa6f6238f38dd556859821194f4)) 




  Without it, --passphrase-file doesn't accept parameter value.
- Send the tunnel destination in the Host header of proxy CONNECT requests
([MEN-9262](https://northerntech.atlassian.net/browse/MEN-9262)) ([efc0e40](https://github.com/mendersoftware/mender/commit/efc0e40dd17aea91416d242adc6b175d7dc41e91)) 
...
## mender-connect 3.0.x (2026-09-16)
...
- Do not ignore terminal ignore terminal port-forwarding error
 ([6f2f342](https://github.com/mendersoftware/mender-connect/commit/6f2f342ac6595301ea064174f5acb1e7a0109df2)) 
...
- Handle partial write to port-forwarding connection
 ([85a9f43](https://github.com/mendersoftware/mender-connect/commit/85a9f436d9a8f66f5a0b7383c842ab76c1804320))
...
## mender-container-modules 1.0.x (2026-09-16)
